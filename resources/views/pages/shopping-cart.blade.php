    ...
    <div id="content">
            ...
            <table class="shop_table beta-shopping-cart-table" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th class="product-status">Curreny quantity</th>
                ...
                <tbody>
                    ...
                    <form action="{{ route('update-cart', ['id'=>  $product['item']['id'] ])}}" method="post">
                        @csrf
                        <tr class="cart_item">
                            ...
                            <td class="product-price">
                                ...
                                <span class="amount">{{ number_format($product['item']['unit_price']) }}</span>
                                <input type="hidden" id="unit_price" value="{{ $product['item']['unit_price'] }}">
                                @else
                                <span class="amount">{{ number_format($product['item']['promotion_price']) }}</span>
                                <input type="hidden" id="promotion_price" value="{{ $product['item']['promotion_price'] }}">
                                @endif
                            </td>
                            ...
                            <input type="hidden" value="{{ number_format($product['item']['unit_price']) }}">
                ...
                <tfoot>
                    <tr>
                        <td colspan="6" class="actions">
                            ...
                            <button type="submit" class="beta-btn primary" name="proceed"><a href="{{ route('checkout-page') }}">Proceed to Checkout <i class="fa fa-chevron-right"></i></a></button>
                        </td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="cart-collaterals">
            ...
            <div class="cart-totals pull-right">
                ...
                <div class="cart-totals-row"><span>Order Total:</span> <span> <?php echo  number_format($totalPrice) ?></span></div>
            </div>
